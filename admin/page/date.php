        ...
        <div class="card-body">
            ...
            <table class="table table-striped table-hover table-bordered table-responsive bg-white rounded shadow-sm ">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center align-middle"><?php echo $row['id_day'];?></td>
                        <td class="text-center align-middle"><?php echo $row["num_day"];?></td>
                        <td class="text-center align-middle">วัน</td>
                        <td class="text-center align-middle">
                            <a href="../admin/dashboard.php?page=date_edit&id_day=<?php echo $row["id_day"];?>"
